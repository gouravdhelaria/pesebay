...
END;
	     		break;
	     case "approve": 
	     		if(isset($_GET["transid"]) && $_GET["transid"] != "" && isset($_GET["bid"]) && $_GET["bid"] != ""){
		     		$html = getEditApproveBookForm($_GET["transid"],$_GET["bid"]);
			}
			else{
...
END;
	     ...
	     case "deliver": 
	     		if(isset($_GET["bid"]) && $_GET["bid"] != ""){
		     		$html = getEditDeliverForm($_GET["bid"]);
			}
			else{
				$html = getDeliverTable();
			}
	     		$nav .=<<<END
...
END;
	     ...
	     case "insertBook": $html = getInsertBookForm();
	     		$nav .=<<<END
				$("#listBooksTab").addClass("active");
END;
	     		break;
